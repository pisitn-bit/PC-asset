...
-- ----------------------------
-- Table structure for cpu_vendor
-- ----------------------------
DROP TABLE IF EXISTS "public"."cpu_vendor";
CREATE TABLE "public"."cpu_vendor" (
  "id" numeric NOT NULL,
...
-- ----------------------------
-- Primary Key structure for table cpu_vendor
-- ----------------------------
ALTER TABLE "public"."cpu_vendor" ADD CONSTRAINT "cpu_vendor_pkey" PRIMARY KEY ("id");
